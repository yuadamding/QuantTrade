...
| [0007](0007-benchmark-relative-hold30-alpha-objective.md) | C1-relative alpha, active-risk bands, and evaluator-only factor data define [Hold-30 alpha v3](../prelockbox_hold30_alpha_mech8_v3.md) promotion | Accepted; CPU component-integrated; launch blocked | `tests/test_hold30_alpha_v3_protocol.py`, `tests/test_hold30_alpha_core.py`, `tests/test_hold30_alpha_evaluation.py`, and `tests/test_hold30_alpha_workflow.py` |
