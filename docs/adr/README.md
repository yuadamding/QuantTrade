...
| [0008](0008-parameterized-soft-holding-target.md) | New generic holding APIs default to terminal-aware calibrated soft target 3; legacy Hold-30 protocols bind 30 explicitly | Accepted; core specification and v16 artifact binding implemented, broader generic replay/CLI migration staged | `tests/test_hold_target_protocol.py`, `tests/test_top2000_m03r_v16_initial_state.py`, `tests/test_top2000_m03r_v16_checkpoint.py` |
