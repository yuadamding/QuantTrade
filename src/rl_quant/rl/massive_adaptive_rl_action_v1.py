...
or change the soft trade-cost hurdle bidirectionally.  It cannot relax any
frozen hard compiler limit, emit security weights, execute trades, or authorize
RL training.
"""
...
MASSIVE_ADAPTIVE_RL_ACTION_V1_SPEC_SHA256 = semantic_sha256(
    {
        ...
        "bidirectional_scalar_controls": ("uncertainty", "risk", "trade-cost"),
...
def build_massive_adaptive_rl_action_v1(
    *,
    ...
    body = {
        ...
        "trade_cost_control": float(trade_cost_control),
