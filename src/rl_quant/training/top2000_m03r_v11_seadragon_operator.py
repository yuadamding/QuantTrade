...
def _load_rendered(config: M03RV11CreateOperatorConfig) -> M03RV11RenderedJob:
    ...
    try:
        rendered = M03RV11RenderedJob(**rendered_payload)
    except (TypeError, ValueError) as exc:
...
def prepare_suspended_job_once(
    ...
    *,
    ...
    try:
        ...
        binding = bind_m03r_v11_admitted_suspended_job(
            rendered=rendered,
