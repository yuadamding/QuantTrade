...
MASSIVE_PROFITABILITY_EVALUATION_PLAN_V5_SCHEMA = (
    "rl-quant.massive-profitability-evaluation-plan-v5"
)
MASSIVE_PROFITABILITY_EVALUATION_PLAN_V5_DATASET = (
    "massive-profitability-evaluation-plan-v5"
)
MASSIVE_PROFITABILITY_EVALUATION_PLAN_V5_SOURCE_SCHEMA_SHA256 = semantic_sha256(
    {
        "schema": MASSIVE_PROFITABILITY_EVALUATION_PLAN_V5_SCHEMA,
        "encoding": "canonical-json",
        "publication": "create-only-source-transaction",
    }
)
MASSIVE_PROFITABILITY_EVALUATION_PLAN_V5_SOURCE_SHA256 = file_sha256(Path(__file__))
MASSIVE_PROFITABILITY_EVALUATION_PLAN_V5_SPEC_SHA256 = semantic_sha256(
    {
...
class MassiveProfitabilityEvaluationPlanV5Error(ValueError):
...
def _digest(name: str, value: object) -> str:
    if (
        ...
        raise MassiveProfitabilityEvaluationPlanV5Error(
...
class MassiveProfitabilityEvaluationPlanV5:
    ...
    schema: str = MASSIVE_PROFITABILITY_EVALUATION_PLAN_V5_SCHEMA
    ...
    def validate(self) -> None:
        ...
        if (
            self.schema != MASSIVE_PROFITABILITY_EVALUATION_PLAN_V5_SCHEMA
            or keys != expected
            ...
            != MASSIVE_FINALIZED_PROFITABILITY_P0_RECEIPT_SHA256
            or self.specification_sha256 != MASSIVE_PROFITABILITY_EVALUATION_PLAN_V5_SPEC_SHA256
            or self.implementation_source_sha256
            != MASSIVE_PROFITABILITY_EVALUATION_PLAN_V5_SOURCE_SHA256
        ...
        if (
            ...
            != MASSIVE_PROFITABILITY_EVALUATION_PLAN_V5_SOURCE_SCHEMA_SHA256
...
def materialize_massive_profitability_evaluation_plan_v5(
    *,
    root: str | Path,
    artifact_id: str,
    ...
    if any(not isinstance(row, MassiveProfitabilityOuterPredictionsV3) for row in ordered):
        raise MassiveProfitabilityEvaluationPlanV5Error(
            "EvaluationPlan V5 rejects every prediction generation except V3"
        )
    replay_pairs = tuple(
        (
    ...
    if (
        ...
        != phase_plan.semantic_receipt_sha256
        or authorized_replay.tournament_plan_receipt_sha256
        != reloaded.receipt_sha256
        or replay_pairs != prediction_pairs
    ):
        raise MassiveProfitabilityEvaluationPlanV5Error(
            "evaluation V5 roots do not share one embargoed tournament"
        )
    inventory = []
    for prediction in ordered:
        prediction.validate()
    ...
    semantic = {
        ...
        "specification_sha256": MASSIVE_PROFITABILITY_EVALUATION_PLAN_V5_SPEC_SHA256,
        "implementation_source_sha256": MASSIVE_PROFITABILITY_EVALUATION_PLAN_V5_SOURCE_SHA256,
    ...
    relative = f"massive-profitability/evaluation-plan-v5/{artifact_id}.json"
    publish_massive_source_object(
        stream=BytesIO(canonical_json_file_bytes(semantic)),
        root=root,
        relative_payload_path=relative,
        dataset_id=MASSIVE_PROFITABILITY_EVALUATION_PLAN_V5_DATASET,
        source_object_key=relative,
        requested_at_ms=committed_at_ms,
        downloaded_at_ms=committed_at_ms,
        schema_sha256=MASSIVE_PROFITABILITY_EVALUATION_PLAN_V5_SOURCE_SCHEMA_SHA256,
    ...
    return parse_massive_profitability_evaluation_plan_v5(
        root=root, loaded_source=loaded
    )


def parse_massive_profitability_evaluation_plan_v5(
    *, root: str | Path, loaded_source: LoadedMassiveSourceObject
    ...
    result = MassiveProfitabilityEvaluationPlanV5(
...
__all__ = [
    ...
    "MASSIVE_PROFITABILITY_EVALUATION_PLAN_V5_SOURCE_SCHEMA_SHA256",
    "MASSIVE_PROFITABILITY_EVALUATION_PLAN_V5_SOURCE_SHA256",
    "MASSIVE_PROFITABILITY_EVALUATION_PLAN_V5_SPEC_SHA256",
    "MassiveProfitabilityEvaluationPlanV5",
    "MassiveProfitabilityEvaluationPlanV5Error",
