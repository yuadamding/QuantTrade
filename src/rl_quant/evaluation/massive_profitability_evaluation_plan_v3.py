"""Fixed-weight evaluation plan bound to the embargoed V2 tournament."""
...
MASSIVE_PROFITABILITY_EVALUATION_PLAN_V3_SCHEMA = (
    "rl-quant.massive-profitability-evaluation-plan-v3"
)
MASSIVE_PROFITABILITY_EVALUATION_PLAN_V3_DATASET = (
    "massive-profitability-evaluation-plan-v3"
)
MASSIVE_PROFITABILITY_EVALUATION_PLAN_V3_SOURCE_SCHEMA_SHA256 = semantic_sha256(
    {
        "schema": MASSIVE_PROFITABILITY_EVALUATION_PLAN_V3_SCHEMA,
        "encoding": "canonical-json",
        "publication": "create-only-source-transaction",
    }
)
MASSIVE_PROFITABILITY_EVALUATION_PLAN_V3_SOURCE_SHA256 = file_sha256(Path(__file__))
MASSIVE_PROFITABILITY_EVALUATION_PLAN_V3_SPEC_SHA256 = semantic_sha256(
    {
        ...
        "predictions": "outer-predictions-v2",
...
class MassiveProfitabilityEvaluationPlanV3Error(ValueError):
...
def _digest(name: str, value: object) -> str:
    if (
        ...
        raise MassiveProfitabilityEvaluationPlanV3Error(
...
class MassiveProfitabilityEvaluationPlanV3:
    ...
    schema: str = MASSIVE_PROFITABILITY_EVALUATION_PLAN_V3_SCHEMA
    ...
    def validate(self) -> None:
        ...
        if (
            self.schema != MASSIVE_PROFITABILITY_EVALUATION_PLAN_V3_SCHEMA
            or keys != expected
            ...
            != MASSIVE_FINALIZED_PROFITABILITY_P0_RECEIPT_SHA256
            or self.specification_sha256 != MASSIVE_PROFITABILITY_EVALUATION_PLAN_V3_SPEC_SHA256
            or self.implementation_source_sha256
            != MASSIVE_PROFITABILITY_EVALUATION_PLAN_V3_SOURCE_SHA256
        ...
        if (
            ...
            != MASSIVE_PROFITABILITY_EVALUATION_PLAN_V3_SOURCE_SCHEMA_SHA256
...
def materialize_massive_profitability_evaluation_plan_v3(
    *,
    root: str | Path,
    artifact_id: str,
    ...
    if (
        ...
        raise MassiveProfitabilityEvaluationPlanV3Error(
            "evaluation V3 roots do not share one embargoed tournament"
        )
    inventory = []
    for prediction in ordered:
        ...
        if (
            ...
            raise MassiveProfitabilityEvaluationPlanV3Error(
                "prediction V2 is detached from the frozen V3 evaluation roots"
            )
        body = {
    ...
    semantic = {
        ...
        "specification_sha256": MASSIVE_PROFITABILITY_EVALUATION_PLAN_V3_SPEC_SHA256,
        "implementation_source_sha256": MASSIVE_PROFITABILITY_EVALUATION_PLAN_V3_SOURCE_SHA256,
    ...
    relative = f"massive-profitability/evaluation-plan-v3/{artifact_id}.json"
    publish_massive_source_object(
        stream=BytesIO(canonical_json_file_bytes(semantic)),
        root=root,
        relative_payload_path=relative,
        dataset_id=MASSIVE_PROFITABILITY_EVALUATION_PLAN_V3_DATASET,
        source_object_key=relative,
        requested_at_ms=committed_at_ms,
        downloaded_at_ms=committed_at_ms,
        schema_sha256=MASSIVE_PROFITABILITY_EVALUATION_PLAN_V3_SOURCE_SCHEMA_SHA256,
    ...
    return parse_massive_profitability_evaluation_plan_v3(
        root=root, loaded_source=loaded
    )


def parse_massive_profitability_evaluation_plan_v3(
    *, root: str | Path, loaded_source: LoadedMassiveSourceObject
    ...
    result = MassiveProfitabilityEvaluationPlanV3(
...
__all__ = [
    ...
    "MASSIVE_PROFITABILITY_EVALUATION_PLAN_V3_SOURCE_SCHEMA_SHA256",
    "MASSIVE_PROFITABILITY_EVALUATION_PLAN_V3_SOURCE_SHA256",
    "MASSIVE_PROFITABILITY_EVALUATION_PLAN_V3_SPEC_SHA256",
    "MassiveProfitabilityEvaluationPlanV3",
    "MassiveProfitabilityEvaluationPlanV3Error",
