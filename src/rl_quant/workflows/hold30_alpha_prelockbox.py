...
V3_LATER_GENERATION_SOURCE_TESTS = (
    ...
    (
        "src/rl_quant/training/top2000_m03r_v11_checkpoint.py",
        "tests/test_top2000_m03r_v11_checkpoint.py",
    ),
    (
        "src/rl_quant/training/top2000_m03r_v11_fold.py",
        "tests/test_top2000_m03r_v11_fold.py",
    ),
    (
        "src/rl_quant/training/top2000_m03r_v11_predictive_worker.py",
        "tests/test_top2000_m03r_v11_predictive_worker.py",
    ),
    (
        "src/rl_quant/training/top2000_m03r_v11_pretraining_runtime.py",
        "tests/test_top2000_m03r_v11_pretraining_runtime.py",
    ),
    (
        "src/rl_quant/training/top2000_m03r_v11_pretraining_step.py",
        "tests/test_top2000_m03r_v11_pretraining_step.py",
    ),
    (
        "src/rl_quant/training/top2000_m03r_v11_training_runtime.py",
        "tests/test_top2000_m03r_v11_training_runtime.py",
    ),
    (
        "src/rl_quant/training/top2000_m03r_v11_qualification_runtime.py",
        "tests/test_top2000_m03r_v11_qualification_runtime.py",
    ),
    (
        "src/rl_quant/training/top2000_m03r_v11_runtime.py",
        "tests/test_top2000_m03r_v11_runtime.py",
    ),
    (
        "src/rl_quant/training/top2000_m03r_v11_fold_qualification.py",
        "tests/test_top2000_m03r_v11_fold_qualification.py",
    ),
    (
        "src/rl_quant/training/top2000_m03r_v11_package.py",
        "tests/test_top2000_m03r_v11_package.py",
    ),
    (
        "src/rl_quant/training/top2000_m03r_v11_kubernetes.py",
        "tests/test_top2000_m03r_v11_kubernetes.py",
    ),
    (
        "src/rl_quant/training/top2000_m03r_v11_rank_objective.py",
        "tests/test_top2000_m03r_v11_rank_objective.py",
    ),
    (
        "src/rl_quant/training/top2000_m03r_v11_residual_operator.py",
        "tests/test_top2000_m03r_v11_residual_operator.py",
    ),
    (
        "src/rl_quant/training/top2000_m03r_v11_schedule.py",
        "tests/test_top2000_m03r_v11_schedule.py",
    ),
    (
        "src/rl_quant/training/top2000_m03r_v11_selection.py",
        "tests/test_top2000_m03r_v11_selection.py",
    ),
    (
        "src/rl_quant/workflows/top2000_m03r_v11_predictive.py",
        "tests/test_top2000_m03r_v11_predictive_workflow.py",
    ),
    (
        "src/rl_quant/workflows/top2000_m03r_v11_package_builder.py",
        "tests/test_top2000_m03r_v11_package_builder.py",
    ),
    (
        "src/rl_quant/training/top2000_m03r_v11_seadragon_lifecycle.py",
        "tests/test_top2000_m03r_v11_seadragon_boundaries.py",
    ),
    (
        "src/rl_quant/training/top2000_m03r_v11_seadragon_operator.py",
        "tests/test_top2000_m03r_v11_seadragon_boundaries.py",
    ),
    (
        "src/rl_quant/workflows/top2000_m03r_v11_seadragon_prepare.py",
        "tests/test_top2000_m03r_v11_seadragon_boundaries.py",
    ),
    (
        "src/rl_quant/training/top2000_m03r_v9_seadragon_lifecycle.py",
        "tests/test_top2000_m03r_v9_seadragon_lifecycle.py",
    ),
    (
        "src/rl_quant/training/top2000_m03r_v9_seadragon_operator.py",
        "tests/test_top2000_m03r_v9_seadragon_operator.py",
    ),
    (
        "src/rl_quant/workflows/top2000_m03r_v9_seadragon_prepare.py",
        "tests/test_top2000_m03r_v9_seadragon_prepare.py",
    ),
)
