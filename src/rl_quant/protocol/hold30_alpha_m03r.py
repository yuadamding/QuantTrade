"""Immutable M03R Hold-30 active-alpha scientific protocol.

This is a new protocol generation.  It supersedes the *design intent* of the
V3 tranche without changing, aliasing, or accepting any V3 artifact identity.
...
M03R_PROTOCOL_GENERATION = "prelockbox-hold30-active-alpha-m03r-v4"
M03R_SUPERSEDED_PROTOCOL_GENERATION = "prelockbox-hold30-alpha-mech8-v3"
M03R_DESIGN_ID = "daily_raw_pit300_hold30_m03r"
...
class M03RTemporalContract:
    ...
    slow_raw_context_trading_sessions: int = 252
...
class M03RActiveRiskContract:
    ...
    def __post_init__(self) -> None:
        ...
        required = (0.0, 0.06, 0.0, 0.04, 0.0, 0.10, 0.01, 1.0 / 30.0)
        if exact != required:
...
class M03RFactorSectorProjectionContract:
    ...
    projection_objective: str = "minimum-l2-distance-to-requested-active-weights"
...
class M03RModelContract:
    ...
    raw_fast_branch_required: bool = True
    raw_slow_branch_required: bool = True
    ...
    def __post_init__(self) -> None:
        ...
        if not all(
            (
                self.raw_fast_branch_required,
                self.raw_slow_branch_required,
...
class M03REnsembleExecutionContract:
    ...
    post_ensemble_projection_application_count: int = 1
    risk_manifest_schema: str = "rl-quant.m03r-factor-sector-risk-manifest-v1"
    ...
    def __post_init__(self) -> None:
        ...
        if self.post_ensemble_projection_application_count != 1:
            raise M03RProtocolError(
                "M03R projection must run exactly once after ensemble"
            )
...
class M03RSetting:
    ...
    uncertainty_scaled_sizing: bool
...
_CANONICAL_COMMON = {
    ...
    "uncertainty_scaled_sizing": True,
...
M03R_SETTINGS: tuple[M03RSetting, ...] = (
    M03RSetting(
        ...
        False,
        None,
        "Hold-30 architecture with the absolute-return objective only.",
    ),
    M03RSetting(
        1,
        ...
        False,
        None,
        "M00 with only C1 benchmark subtraction added.",
    ),
    M03RSetting(
        2,
        ...
        False,
        None,
        "M01 plus active-risk controls and factor/sector projection, without alpha heads.",
    ),
    M03RSetting(
        3,
        ...
        **_CANONICAL_COMMON,
        ...
        ablation_of=None,
        description=(
            "Canonical age-aware Hold-30 active-alpha policy with uncertainty sizing, "
    ...
    M03RSetting(
        ...
        **{**_CANONICAL_COMMON, "uncertainty_scaled_sizing": False},
        promotion_eligible=False,
        ablation_of=M03R_CANONICAL_SETTING_ID,
        description="Canonical M03R with uncertainty-based sizing disabled.",
    ),
    M03RSetting(
        5,
        "A05-fixed-te-floor",
        **{**_CANONICAL_COMMON, "annual_tracking_error_floor": 0.02},
        promotion_eligible=False,
        ablation_of=M03R_CANONICAL_SETTING_ID,
    ...
    M03RSetting(
        6,
        "A06-sharpe-overlay",
        **{**_CANONICAL_COMMON, "sharpe_mode": "separate-total-risk-overlay"},
        promotion_eligible=False,
        ablation_of=M03R_CANONICAL_SETTING_ID,
    ...
    M03RSetting(
        7,
        "A07-direct-sharpe",
        **{**_CANONICAL_COMMON, "sharpe_mode": "direct-two-pass-gradient"},
        promotion_eligible=False,
        ablation_of=M03R_CANONICAL_SETTING_ID,
    ...
    M03RSetting(
        ...
        **{**_CANONICAL_COMMON, "exit_hazard_mode": "fixed-hold30-prior"},
        promotion_eligible=False,
        ablation_of=M03R_CANONICAL_SETTING_ID,
    ...
    M03RSetting(
        9,
        "A09-no-long-context",
        **{**_CANONICAL_COMMON, "slow_context_trading_sessions": 63},
        promotion_eligible=False,
        ablation_of=M03R_CANONICAL_SETTING_ID,
        description="Canonical M03R with the 252-session slow branch truncated to 63 sessions.",
    ),
    M03RSetting(
        10,
        "A10-no-factor-neutral-projection",
        **{**_CANONICAL_COMMON, "factor_sector_projection": False},
        promotion_eligible=False,
        ablation_of=M03R_CANONICAL_SETTING_ID,
...
def resolve_m03r_setting(setting_id: str) -> M03RSetting:
    """Resolve only an exact M03R setting identity; aliases fail closed."""
...
def validate_m03r_artifact_identity(
    *, protocol_generation: str, design_id: str, setting_id: str
    ...
    return resolve_m03r_setting(setting_id)
