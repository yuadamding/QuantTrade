...
def test_v14_scale_quantiles_keep_probability_tensor_on_cuda_device() -> None:
...
def test_v14_fixed_rank_target_compares_simplex_mass_in_one_dtype() -> None:
    ...
    # This is the exact failure mode from the first v14 qualification attempt:
...
def test_v14_sleeve_uses_origin_action_mask_and_post_fill_return(
    ...
    loaded = _Validated(
        setting_index=0,
        setting_id=M03R_V14_SETTINGS[0].setting_id,
        fold_index=0,
        asset_axis_sha256=axis,
    ...
    monkeypatch.setattr(
        "rl_quant.training.top2000_m03r_v14_runtime.project_m03r_v9_active_book",
